      ...
      <section className="flex flex-col w-full h-[100vh] py-4">
        ...
        <div className="flex items-center justify-between w-[95%] h-[95%]">
          <div className="flex flex-col items-center justify-between w-[15%] h-[550px]">
            <img src='https://bit.ly/3eXgVU4' alt="product-pic1" className="w-full h-[32%] cursor-pointer hover:border-[1px] border-red-600 shadow-md" onClick={selectPic}/>
            <img src='https://bit.ly/3eXgVU4' alt="product-pic2" className="w-full h-[32%] cursor-pointer hover:border-[1px] border-red-600 shadow-md" onClick={selectPic}/>
            <img src='https://bit.ly/3eXgVU4' alt="product-pic3" className="w-full h-[32%] cursor-pointer hover:border-[1px] border-red-600 shadow-md" onClick={selectPic}/>
          </div>
          <div className="relative flex items-center justify-center w-[50%] h-[600px] shadow-lg bg-white"> 
