...
const Details = (props) => {
  ...
  useEffect(() => {
    ...
    if (isAuthenticated) {
      const liked = favorites.find(
        (e) => e.id === details.id || e.id === details._id
      );
  ...
  return (
    <div>
      {details === {} ? (
        <div className={"mt-48"}>cargando</div>
      ) : error ? (
        <NotFound />
      ) : (
        <div>
          ...
          <section className="relative flex flex-col w-full h-[100vh] py-8 mt-[60px]">
            <div className="flex items-center w-[95%] h-[45px] my-8">
              ...
              <p className="text-xl ml-2 text-[#790729] font-semibold">
                {" "}
                Product{" "}
              </p>
            </div>
            <div className="sticky top-40 flex items-center justify-between w-[95%] h-[95%]">
              ...
              <div className="relative flex items-center justify-center w-[50%] h-[550px] shadow-lg bg-white">
              ...
              <div className="flex flex-col items-start w-[30%] h-[580px] mt-[50px]">
                <h1 className="mb-4 text-4xl font-bold  text-[#790729]">
                  {details.name}
                </h1>
                ...
                </p>
                {
                  details.type === "jersey" ? (
                    <div className="flex justify-around items-center w-[80%] h-[50px]">
                      <div className="flex items-center justify-center h-full w-[20%] mr-1 text-xl hover:font-bold hover:border-2 text-[#790729] border-[1px] border-[#790729] cursor-pointer">
                        XS
                      </div>
                      <div className="flex items-center justify-center h-full w-[20%] mr-1 text-xl hover:font-bold hover:border-2 text-[#790729] border-[1px] border-[#790729] cursor-pointer">
                        S
                  ...
                  ) : null //NO SPINNER NEEDED JUST ERASING SIZE IF NOT JERSEY
                }
                <p className="flex justify-start items-center w-[80%] h-[50px] my-2 text-3xl text-[#790729] border-b-[1px] border-gray-200">
                  DESCRIPCIÓN
                </p>
                ...
                <button
                  onClick={handleClick}
                  className="w-[8em] h-[3em] mt-4 rounded-md bg-[#790729] text-white font-bold font-[Lato]"
                >
                  {" "}
                  Al Carrito
                </button>
