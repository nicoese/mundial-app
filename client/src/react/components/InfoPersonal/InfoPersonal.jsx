        ...
        <Formik
          ...
          validate={(values) => {
            ...
            if (!values.address) {
              ...
              !/^[A-Za-z0-9 _]*[A-Za-z0-9][A-Za-z0-9 _]*$/.test(values.address)
            ) {
              errors.address =
                "La direccion solo puede contener letras y numeros";
            }
            ...
            if (!values.postalCode) {
              ...
              errors.postalCode =
                "El codigo postal solo puede contener numeros y letras";
            }
            if (!values.country) {
            ...
            if (!values.telephone) {
              ...
              errors.telephone =
                "Ingresa un numero de telefono valido, no te olvides de incluir el Nro. de area";
            }
              ...
              <div className={s.divOne}>
                ...
                <div className={s.divUbication}>
                  ...
                  <ErrorMessage
                    name={"address"}
                    component={() => (
                      <p className={s.pError}>{errors.address}</p>
                    )}
                  />
                </div>
              ...
              <div className={s.divTwo}>
                ...
                <div className={s.divDepartment}>
                  ...
                  <ErrorMessage
                    name={"apartment"}
                    component={() => (
                      <p className={s.pError}>{errors.apartment}</p>
                    )}
                  />
                </div>
                <div className={s.divCp}>
                  ...
                  <ErrorMessage
                    name={"postalCode"}
                    component={() => (
                      <p className={s.pError}>{errors.postalCode}</p>
                    )}
                  />
                </div>
                <div className={s.divPhone}>
                  ...
                  <ErrorMessage
                    name={"telephone"}
                    component={() => (
                      <p className={s.pError}>{errors.telephone}</p>
                    )}
                  />
                </div>
                <button type={"submit"} className={s.btnGuardar}>
                  Guardar
                </button>
              </div>
            </Form>
