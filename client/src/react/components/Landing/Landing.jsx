      ...
      <section>
        <div className="hero-ctn">
          <div className="hero-txt-btns">
            ...
            <p className="hero-p">
              Si sos un apasionado del futbol y principalmente del mundial,
              estas en el lugar correcto. Vas a poder conseguir los mejores
              productos al alcance de un solo click!
            </p>
            ...
            <div className="check-icons">
              <div className="chek">
                ...
                <p className="check-p">
                  Indumentaria oficial de mundial Qatar 2022
                </p>
              </div>
            </div>
          </div>
