...
const UserProfile = () => {
    ...
    return (
        <>
            ...
            <div className="flex flex-col h-[100vh] w-full mt-24">
                ...
                <div className="flex flex-col items-center w-full h-full">
                    <div className="flex flex-col items-center w-[60%] h-full">
                        <div className="w-[60%] h-fit border-2 mt-[70px] text-[#790729]">
                            <h4 className="flex items-center justify-center h-[70px] text-4xl font-bold font-['Lato']">{user && user.name}</h4>
                        </div>
                        <div className="w-[60%] h-fit mt-8 border-2">
                            ...
                            <div className="flex items-center w-full h-fit p-4">
                                <MdAlternateEmail size={40} color='#790729'/>
                                <p className="text-xl text-gray-800 font-['Lato'] ml-2">{user && user.email}</p>
                            </div>
                ...
                <div id="bg-image-modal" className="modal-img-ctn">
                    <div id='modal-img' className="modal-img">
                        ...
                        />
                        <button
                            className="w-[8em] h-[3em] mr-2 rounded-md bg-red-600 hover:bg-red-800 text-white font-bold font-[Lato]"> Guardar
                        </button>
